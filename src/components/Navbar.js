...
const Icons = {
  ...
  // ── NEW: Restock Log icon (box/package symbol) ────────────────────────
  restock: () => (
    <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
function Navbar() {
  ...
  // Safe localStorage access (prevents Vercel build crash)
